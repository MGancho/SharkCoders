...
match escolha:
    case _ if escolha == 1:
        if numero % 2 == 0:
            for x in range(numero,numero2,2):
                print('a soma de todos os números pares entre estes 2 números é de {}',format(x))
        if numero % 2 != 0:
    ...
    case _ if escolha == 2:
        if numero % 2 == 0:
            for x in range(numero+1, numero2, 2):
                print('a soma de todos os números ímpares entre estes 2 números é de {}',format(x))
        if numero % 2 != 0:
            for x in range(numero + 1, numero2, 2):
                print('a soma de todos os números ímpares entre estes 2 números é de {}', format(x))
    case _:
